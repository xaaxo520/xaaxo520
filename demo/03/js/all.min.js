...
var Flowtime = (function() {
  ...
  var z = (function() {
    ...
    function be(b3, b2, b4) {
      var b1 = bq;
      var b0 = b3 == !M;
      if (b2 == true && bs[bT][bq].length > 0 && bC[bT][bq] < bs[bT][bq].length - 1 && b0 != true && b4 ==
        false) {
        bn(bT, bq)
      } else {
        b1 = 0;
                ...
                if (b4 == bT) {
                  if (b2 > bq) {
                    ...
                    if (b2 < bq) {
                      ...
                      if (b2 == bq) {
                        if (p == true && (D.section > z.getPageIndex().section || D.page > z.getPageIndex()
                            .page)) {
                          for (var b3 = 0; b3 < b0.length; b3++) {
                            bn(b4, b2, b3)
                          }
  ...
  function d(e) {
    return (e.getAttribute("data-id") != null ? e.getAttribute("data-id").replace(/__/, "") : e.getAttribute(
      "data-prog").replace(/__/, ""))
  }
          ...
          for (var bg = 0; bg < ba.length; bg++) {
            ...
            if (bf != undefined) {
              for (var bc = 0; bc < bf.length; bc++) {
                ...
                if (ao) {
                  bh.style[Brav1Toolbox.getPrefixed("transform")] = "translateX(" + a8 + "px) translateY(" + e +
                    "px)"
                } else {
  ...
  function R(ba) {
    if (ba) {
      ...
      J.style[Brav1Toolbox.getPrefixed("transform")] = "translate(" + e + "%, " + bc + "%) scale(" + bb / 100 +
        ", " + bb / 100 + ")"
    }
  }
  ...
  function Q(a8) {
    if (a8) {
      ...
      J.style[Brav1Toolbox.getPrefixed("transform")] = "translate(" + e + "%, " + bb + "%) scale(" + ba / 100 +
        ", " + ba / 100 + ")"
    }
  }
  ...
  g[h] = {
    ...
    helpers: {
      ...
      injectCss: function(b, a) {
        for (var c = "", d = document.getElementsByTagName("style"), e = a.replace(/\$1/g, b.settings
            .imageLocation), i = 0, f = d.length; i < f; i++) {
